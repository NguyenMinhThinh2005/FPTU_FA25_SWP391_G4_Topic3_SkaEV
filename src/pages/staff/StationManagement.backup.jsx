    ...
    <Box sx={{ p: 3 }}>
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" gutterBottom>
                  Hoạt động: {station.activeChargers}/{station.totalChargers}{" "}
                  bộ sạc
                </Typography>
                <LinearProgress
                  variant="determinate"
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 3 }}>
        <Tabs value={tabValue} onChange={handleTabChange}>
          <Tab label="Trạng thái bộ sạc" />
          <Tab label="Nhật ký bảo trì" />
          <Tab label="Hiệu suất" />
        </Tabs>
      </Box>
        ...
        <Card>
          <CardContent>
            <Typography variant="h6" fontWeight="bold" gutterBottom>
              {selectedStation.name} - Trạng thái bộ sạc
            </Typography>
                  ...
                  <Card variant="outlined">
                    <CardContent>
                      ...
                      {charger.status === "charging" && (
                        <Box sx={{ mb: 2 }}>
                          <Typography variant="body2" gutterBottom>
                            Người dùng: {charger.currentUser}
                          </Typography>
                          <LinearProgress
                            variant="determinate"
      ...
      {tabValue === 2 && (
        <Card>
          <CardContent>
            <Typography variant="h6" fontWeight="bold" gutterBottom>
              Chỉ số hiệu suất trạm
            </Typography>
            <Alert severity="info">
              Phân tích hiệu suất sẽ được hiển thị ở đây bao gồm thống kê sử dụng,
              tiêu thụ năng lượng, tạo doanh thu và chỉ số hiệu quả.
            </Alert>
          </CardContent>
        </Card>
      )}
      ...
      >
        <DialogTitle>
          Lên lịch bảo trì - {selectedCharger?.name}
        </DialogTitle>
        <DialogContent>
          <Box sx={{ mt: 2 }}>
            <FormControl fullWidth sx={{ mb: 2 }}>
              ...
              >
                ...
                <MenuItem value="preventive">Phòng ngừa</MenuItem>
              </Select>
            </FormControl>
