...
const CustomerDashboard = () => {
  ...
  const quickActions = [
    ...
    // Tạm ẩn analytics theo yêu cầu, giữ cấu trúc ngắn gọn
  ];
  ...
  const monthlyStats = {
    ...
    averageCost: Math.round(
      (parseFloat(bookingStats.totalAmount) || 1680000) /
        (parseFloat(bookingStats.totalEnergyCharged) || 245)
    ),
  };
      ...
      {activeCharging && (
        <Alert severity="success" sx={{ mb: 3 }}>
          ...
          <Typography variant="body2">
            Pin: {activeCharging.currentSOC}% • Thời gian còn lại:{" "}
            {activeCharging.timeRemaining} phút
          </Typography>
          <LinearProgress
            variant="determinate"
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" color="text.secondary">
                      ...
                      • {booking.energyDelivered || 0} kWh •{" "}
                      {booking.chargingDuration || 0} phút
                    </Typography>
                  </Box>
                </Box>
